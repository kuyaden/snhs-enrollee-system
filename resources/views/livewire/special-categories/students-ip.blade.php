<div class="p-6 space-y-6">
    {{-- Header Section --}}
    <div class="bg-gradient-to-r from-emerald-50 to-green-50 dark:from-emerald-900/10 dark:to-green-900/10 p-6 rounded-2xl border border-emerald-100 dark:border-emerald-800">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h2 class="text-2xl font-bold text-gray-800 dark:text-white">Indigenous Peoples (IP) Students</h2>
                    <p class="text-gray-600 dark:text-gray-400 mt-1">List of enrolled students identified as part of IP communities</p>
                </div>
            </div>
            <div class="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400">
                <div class="flex items-center gap-1 bg-white dark:bg-gray-800 px-3 py-1 rounded-full border border-emerald-200 dark:border-emerald-800">
    ...
    <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div class="md:col-span-2">
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Search IP students</label>
                <div class="relative">
                    ...
                    <input type="text" 
                           ...
                           class="w-full h-11 pl-10 pr-4 rounded-xl border border-gray-300 dark:border-gray-600 
                                  ...
                                  focus:ring-2 focus:ring-emerald-500 focus:border-transparent shadow-sm transition-all duration-200"
    ...
    @if ($students->isEmpty())
        <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-12 text-center">
            <div class="max-w-md mx-auto">
                ...
                <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-2">No IP students found</h3>
                {{-- <p class="text-gray-500 dark:text-gray-400 mb-4">Try adjusting your search criteria or filters</p>
                <button wire:click="$set('search', '')" class="inline-flex items-center gap-2 px-4 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition-colors">
    ...
    @else
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center space-x-3">
                                        <div class="relative">
                                            ...
                                            @else
                                                <div class="w-10 h-10 bg-gradient-to-br from-emerald-400 to-emerald-600 rounded-xl flex items-center justify-center shadow-sm">
        ...
        <div class="flex items-center justify-between bg-white dark:bg-gray-800 p-4 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm">
            <div class="text-sm text-gray-600 dark:text-gray-400">
                Showing {{ $students->firstItem() ?? 0 }} to {{ $students->lastItem() ?? 0 }} of {{ $students->total() }} IP students
            </div>
